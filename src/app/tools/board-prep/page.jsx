...
const REFERENCE_CARDS = [
  {
    ...
    icon: Shield,
    note: "Study identity, Army Values, Warrior Ethos, readiness, professionalism, and service.",
    lines: [
  ...
  },
  {
    title: "NCO Creed",
    icon: ScrollText,
    note: "Practice the creed aloud. Focus on professionalism, competence, mission, and welfare of Soldiers.",
    lines: [
      "No one is more professional than I.",
      "Competence is my watchword.",
      "My two basic responsibilities are mission accomplishment and welfare of Soldiers.",
      "NCOs are professionals, noncommissioned officers, leaders.",
    ],
  },
  {
    title: "Army Song",
    icon: Music,
    note: "Official title: The Army Goes Rolling Along. Study the intro, verse, and refrain from your unit board packet or official Army source.",
    lines: [
      "Know the official title.",
      "Know that it is the official song of the U.S. Army.",
      "Practice the intro, verse, and refrain aloud before the board.",
    ],
  },
  {
  ...
  return (
    <Card>
      <div className="text-center py-4">
        ...
        <p className="text-sm mt-1" style={{ color: T.textMuted }}>{TOTAL} shuffled questions per day. Build streaks and confidence.</p>
