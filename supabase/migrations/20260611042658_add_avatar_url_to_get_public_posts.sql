...
-- single RPC. Privacy semantics match get_public_profiles_for_ids: avatar is
-- exposed only for verified, non-anonymous authors.
-- Rollback: re-create the previous definition (without the avatar column/join)
-- and re-grant execute to anon, authenticated.
