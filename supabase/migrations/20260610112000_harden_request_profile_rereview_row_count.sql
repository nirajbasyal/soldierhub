-- Harden re-review flow so rejected/revoked profiles cannot silently fail.
-- Also lets an already-pending user update their phone number from the re-review page.
