-- ============================================================================
-- Public gate hours manager
-- ============================================================================
-- Purpose:
--   Store public Fort Bliss gate-hours information in Supabase so admins can
--   add, edit, remove, reorder, and deactivate gate-hour entries without code
--   changes.
--
-- Safety:
--   This is public-information scheduling content only. It is not intended to
--   represent real-time operational/security gate status.
-- ============================================================================
...
select seed.name, seed.label, seed.hours, seed.status_type, seed.open_time::time, seed.close_time::time, seed.days, seed.note, seed.is_active, seed.display_order
from (
  values
...
) as seed(name, label, hours, status_type, open_time, close_time, days, note, is_active, display_order)
where not exists (
  select 1 from public.gates existing where lower(existing.name) = lower(seed.name)
);
